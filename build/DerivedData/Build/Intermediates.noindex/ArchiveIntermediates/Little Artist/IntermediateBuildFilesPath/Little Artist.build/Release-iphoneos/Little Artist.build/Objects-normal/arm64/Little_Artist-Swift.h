...
#ifndef LITTLE_ARTIST_SWIFT_H
#define LITTLE_ARTIST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Little_Artist",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// that routes CloudKit share acceptance to <code>SceneDelegate</code>.
SWIFT_CLASS("_TtC13Little_Artist11AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
/// Returns a scene configuration that uses <code>SceneDelegate</code> so that
/// <code>windowScene(_:userDidAcceptCloudKitShareWith:)</code> is delivered.
...
- (void)application:(UIApplication * _Nonnull)application userDidAcceptCloudKitShareWithMetadata:(CKShareMetadata * _Nonnull)cloudKitShareMetadata;
...
SWIFT_CLASS("_TtC13Little_Artist13SceneDelegate")
...
/// When used with <code>UIActivityViewController</code>, this replaces the default
/// iCloud link preview with the child’s avatar and a personalised title.
SWIFT_CLASS("_TtC13Little_Artist21ShareInviteItemSource")
@interface ShareInviteItemSource : NSObject <UIActivityItemSource>
